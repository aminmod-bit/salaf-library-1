  ...
  return (
    <div className="fade-in" style={{ maxWidth: 1280, margin: '0 auto' }}>
      <section className="glass-card" style={{ padding: 32, marginBottom: 22, background: 'linear-gradient(135deg, rgba(13,42,24,.96), rgba(7,19,11,.94))' }}>
        ...
        <h1 style={{ color: '#f0f4f1', fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: 950, lineHeight: 1.05, marginBottom: 12 }}>
      ...
      {selected ? (
        <section className="glass-card" style={{ padding: 24 }}>
          <div dir="rtl" style={{ fontFamily: 'Amiri, serif', color: '#d4af37', fontSize: 30, marginBottom: 12 }}>{selected.titleAr}</div>
          <p style={{ color: '#9db8a3', lineHeight: 1.7, marginBottom: 18 }}>{selected.description}</p>
          <div style={{ padding: 20, border: '1px dashed rgba(212,175,55,.24)', borderRadius: 16, color: '#9db8a3', marginBottom: 18 }}>
