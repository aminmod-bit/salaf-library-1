...
const css = `
.audio-player-bar{position:fixed;bottom:0;left:260px;right:0;min-height:86px;background:linear-gradient(135deg,rgba(9,24,16,.98),rgba(10,31,18,.98));border-top:1px solid rgba(212,175,55,.22);backdrop-filter:blur(20px);z-index:100;display:flex;align-items:center;padding:12px 22px;gap:18px;box-shadow:0 -20px 60px rgba(0,0,0,.35)}.audio-cover{width:52px;height:52px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(0,0,0,.45);position:relative}.audio-cover.playing::after{content:'';position:absolute;inset:-5px;border-radius:18px;border:1px solid rgba(212,175,55,.45);animation:pulseAudio 1.6s ease-in-out infinite}@keyframes pulseAudio{0%,100%{opacity:.35;transform:scale(.96)}50%{opacity:1;transform:scale(1.05)}}.audio-info{flex:0 0 230px;min-width:0}.audio-info b{display:block;font-size:13px;color:#f0f4f1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.audio-info span{font-size:11px;color:#9db8a3}.audio-controls,.audio-tools{display:flex;align-items:center;gap:9px}.audio-controls button,.audio-tools button{border:0;background:transparent;color:#9db8a3;cursor:pointer;border-radius:10px;padding:7px;display:flex;align-items:center;gap:4px}.audio-tools button{border:1px solid rgba(212,175,55,.16);background:rgba(255,255,255,.04);font-size:11px;color:#d4af37}.audio-tools button.active{background:rgba(212,175,55,.18)}.audio-controls .play{width:42px;height:42px;border-radius:50%;justify-content:center;background:linear-gradient(135deg,#d4af37,#f0c84a);color:#07130b;box-shadow:0 6px 18px rgba(212,175,55,.35)}.audio-progress-wrap{flex:1;display:flex;align-items:center;gap:10px;min-width:180px}.audio-progress-wrap span{font-size:11px;color:#5a7a63;width:44px;text-align:center}.bar{height:6px;flex:1;position:relative;background:rgba(255,255,255,.1);border-radius:999px}.bar>div{height:100%;background:linear-gradient(90deg,#d4af37,#f0c84a);border-radius:999px}.bar input{position:absolute;inset:-6px 0 0 0;width:100%;opacity:.02;cursor:pointer}.volume{display:flex;align-items:center;gap:5px;color:#5a7a63}.volume input{width:72px}@media(max-width:1024px){.audio-player-bar{left:0}}@media(max-width:780px){.audio-player-bar{display:grid;grid-template-columns:44px 1fr auto;gap:10px;padding:10px 12px}.audio-cover{width:44px;height:44px}.audio-info{flex:auto}.audio-progress-wrap{grid-column:1/-1;order:5}.audio-tools{grid-column:1/-1;justify-content:space-between;overflow-x:auto}.volume{display:none}.audio-controls{gap:4px}.audio-tools button{white-space:nowrap}}
`;
